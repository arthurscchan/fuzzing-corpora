...
- **ike**: IKE (Internet Key Exchange) protocol messages, initially 10 files covering IKEv2 protocol with various exchange types, derived from the strongSwan unit tests/regression tests and the IKE standard documentations (RFC 7296).
